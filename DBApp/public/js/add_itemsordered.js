...
addItemsOrderedForm.addEventListener('submit', function (e) {
  ...
  xhttp.open('POST', '/add-itemsordered-ajax', true);
...
addRowToTable = (data) => {
  ...
  let currentTable = document.getElementById('itemsordered-table');
  ...
  deleteCell.onclick = function () {
    deleteItemsOrdered(newRow.itemsorderedID);
  };
  ...
  row.setAttribute('data-value', newRow.itemsorderedID);
